...
语义化版本控制的规范是由 Gravatars 创办者兼 GitHub 共同创办者 [Tom Preston-Werner][tpw] 所建立。

如果您有任何建议，请到 [GitHub 上提出您的问题][askgithub]。



[tpw]: http://tom.preston-werner.com
[askgithub]: https://github.com/mojombo/semver/issues